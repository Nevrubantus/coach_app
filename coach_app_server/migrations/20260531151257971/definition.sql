...
CREATE TABLE "app_user" (
    ...
    "imageOffsetX" double precision,
    "imageOffsetY" double precision
);

-- Indexes
CREATE UNIQUE INDEX "app_user_contact_unique_idx" ON "app_user" USING btree ("contact");

--
-- Class BodyWeightEntry as table body_weight_entry
--
...
--
-- Class CoachAthlete as table coach_athlete
--
...
--
-- Class VideoComment as table video_comment
--
...
--
-- Class Workout as table workout
--
...
--
-- Class WorkoutExercise as table workout_exercise
--
...
--
-- Class WorkoutSet as table workout_set
--
...
--
-- Class WorkoutVideo as table workout_video
--
